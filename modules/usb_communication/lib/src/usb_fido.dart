...
typedef ChangePukNative = Int32 Function(
    Pointer<Utf8> oldPuk, Pointer<Utf8> newPuk);
typedef ChangePukDart = int Function(
    Pointer<Utf8> oldPuk, Pointer<Utf8> newPuk);

typedef ChangeManagementKeyNative = Int32 Function(
    Pointer<Utf8> oldKey, Pointer<Utf8> newKey);
typedef ChangeManagementKeyDart = int Function(
    Pointer<Utf8> oldKey, Pointer<Utf8> newKey);
...
class UsbFido {
  ...
  UsbFido() {
    ...
    _changePuk =
        _lib.lookupFunction<ChangePukNative, ChangePukDart>('changePuk');
    _changeManagementKey =
        _lib.lookupFunction<ChangeManagementKeyNative, ChangeManagementKeyDart>(
            'changeManagementKey');
    _resetToDefaultPin =
        _lib.lookupFunction<ResetToDefaultPinNative, ResetToDefaultPinDart>(
            'resetToDefaultPin');
  }
