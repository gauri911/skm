...
//   final Color backgroundColor = isDarkMode ? Colors.grey[850]! : const Color(0xFFF5F5F5);
//   final Color borderColor = isDarkMode ? Colors.grey[700]! : Colors.grey[300]!;
//   final Color iconColor = isDarkMode ? Colors.grey[400]! : const Color(0xFF666666);
//   final Color selectedIconColor = isDarkMode ? Colors.white : Colors.black;
//   final Color selectedBgColor = isDarkMode ? Colors.grey[700]! : const Color(0xFFE0E0E0);
...
class _SidebarState extends State<Sidebar> {
            ...
            child: Column(
              children: [
                ...
                _buildCollapsedMenuItem(
                    2, Icons.business, '/business', isDarkMode),
                ...
                _buildCollapsedMenuItem(
                    4, Icons.person, '/accounts', isDarkMode),
                _buildCollapsedMenuItem(
                    7, Icons.grid_4x4, '/slots', isDarkMode),
  ...
  Widget _buildCollapsedMenuItem(
      int index, IconData icon, String route, bool isDarkMode) {
    final isSelected = selectedIndex == index;
    final selectedBgColor =
        isDarkMode ? Colors.grey[700] : const Color(0xFFE0E0E0);
    final iconColor = isDarkMode ? Colors.grey[400] : const Color(0xFF666666);
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                _buildMenuItem(2, Icons.business, "Hello Business", '/business',
                    isDarkMode),
                ...
                _buildMenuItem(
                    4, Icons.person, "Account", '/accounts', isDarkMode),
                _buildMenuItem(
                    7, Icons.grid_4x4, "Slots", '/slots', isDarkMode),
  ...
  Widget _buildMenuItem(
      int index, IconData icon, String title, String route, bool isDarkMode) {
    final isSelected = selectedIndex == index;
    final selectedBgColor =
        isDarkMode ? Colors.grey[700] : const Color(0xFFE0E0E0);
    final iconColor = isDarkMode ? Colors.grey[400] : const Color(0xFF666666);
